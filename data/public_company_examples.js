window.PUBLIC_COMPANY_EXAMPLES = [
  {
    ...
    "dataNotes": [
      "Series D 투자단계는 프로젝트 컬럼 체계에 직접 없으므로 가장 가까운 Series C로 매핑했다.",
    ...
    "reasons": [
      "스타트업/벤처의 공개자료를 프로젝트 컬럼 단위로 변환해 모델 입력값을 만들었습니다.",
  ...
  },
  {
    ...
    "dataNotes": [
      ...
      "연매출과 기업가치는 공개자료에서 프로젝트 컬럼과 직접 대응되는 값을 확인하기 어려워 결측으로 처리했다."
    ],
    "inputColumns": {
      "설립연도": 2018,
      "국가": "CT001",
  ...
  },
  {
    ...
    "dataNotes": [
      "국가 코드는 원본 비식별 데이터가 비식별 코드라 CT001을 한국 proxy로 사용했다.",
    ...
    "reasons": [
      "상장기업 비교군의 공개자료를 프로젝트 컬럼 단위로 변환해 모델 입력값을 만들었습니다.",
      "공개자료와 직접 대응되지 않는 컬럼은 임의로 채우지 않고 결측으로 두어 모델의 중앙값 대체 규칙을 적용했습니다.",
  ...
  },
  {
    ...
    "dataNotes": [
      ...
      "총 투자금과 SNS 팔로워 수는 프로젝트 컬럼 정의와 직접 대응되지 않아 결측으로 처리했다."
    ],
    "inputColumns": {
      "설립연도": 1961,
      "국가": "CT001",
  ...
  },
  {
    ...
    "dataNotes": [
      ...
      "총 투자금, 고객수, SNS 팔로워 수는 스타트업형 프로젝트 컬럼과 직접 대응되지 않아 결측으로 처리했다."
    ],
    "inputColumns": {
      "설립연도": 1930,
      "국가": "CT001",
